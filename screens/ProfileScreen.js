...
import { View, Text, StyleSheet, TouchableOpacity, Linking, ActivityIndicator, ScrollView, Alert } from 'react-native';
...
const ProfileScreen = ({ navigation }) => {
  ...
  const handleLogout = async () => {
    try {
      ...
      navigation.replace('Home'); // Remplacez 'Auth' par le nom de votre page d'authentification
    } catch (error) {
      ...
      <View style={styles.container}>
        <View style={styles.profileHeader}>
          <View style={styles.profileIcon}>
            <Text style={styles.initial}>{getInitial(userName)}</Text>
          </View>
